...
public class OrderService {
    ...
    public List<TailorOrder> list(Long businessId) {
        return orderRepository.findAllWithDetailsForBusiness(businessId);
    }

    @Transactional(readOnly = true)
    public TailorOrder get(Long businessId, Long orderId) {
        return orderRepository.findByIdAndBusiness_Id(orderId, businessId).orElseThrow();
    }
    ...
    public TailorOrder create(Long businessId, OrderWriteRequest req) throws JsonProcessingException {
        ...
        long serial = orderRepository.maxSerialNumber(businessId) + 1;
